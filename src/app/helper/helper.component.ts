...
export class HelperComponent {
  ...
  productSearch(keyword:string) {
    ...
    if (this.searchedKeyword) {
      this.helperService.getData(this.searchedKeyword)
        .subscribe((res: any) => {
          this.searchResults = res.data;
          this.productDataAvailable = this.searchResults.length != 0 ? true : false;
          this.search_results = this.searchResults.length > 0;
  ...
  productpageDropdownChanged() {
    ...
    if (this.productpageDropdownSelectedValue == 'Product') {
      ...
      this.helperService.getCategoriesDataByISBN(this.productPageISBN).subscribe((res: any) => {
        ...
        this.classifications_data = this.classification_data_arr.length > 0;
      ...
      this.helperService.getClassificationsDataByIsbn(this.productPageISBN).subscribe((res: any) => {
        ...
        this.categories_data = this.categories_data_arr.length > 0;
